                ...
                <div class="card-body table-responsive p-0">
                    <div class="p-3">
                        <form action="{{ route('products.update', $product->id) }}" method="POST"
                            ...
                            <div class="row justify-content-start">
                                ...
                                <div class="col-6 mb-1">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="name" id="name"
                                        value="{{ old('name', $product->name) }}" aria-describedby="emailHelp">
                                </div>
                                <div class="col-6 mb-1">
                                ...
                                <div class="col-6 mb-1">
                                    ...
                                    <input type="number" class="form-control form-control-sm" name="price" id="price"
                                        value="{{ old('price', $product->price) }}" aria-describedby="emailHelp">
                                </div>
                                <div class="col-6 mb-4">
                                    ...
                                    <textarea class="form-control form-control-sm form-control form-control-sm-sm" name="short_description"
                                        id="short_description" cols="4" rows="4">{{ old('short_description', $product->short_description) }}</textarea>
                                </div>
                                <div class="col-6 mb-4">
                                    <label for="description" class="mt-2">Description</label>
                                    <textarea class="form-control form-control-sm form-control form-control-sm-sm" name="description" id="editor"
                                        cols="4" rows="4">{{ old('description', $product->description) }}</textarea>
                                </div>
                            </div>
                            ...
                            <img id="img-preview" src="{{ asset($product->image) }}" width="200px" height="200px" />
                            <br><br>
