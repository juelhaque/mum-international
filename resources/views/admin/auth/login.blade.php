...
<head>
    ...
    <title>Mum International|Administrative Panel</title>
    ...
    <link rel="stylesheet" href="{{ asset('ui/backend/css/adminlte.css') }}">
    <link rel="stylesheet" href="{{ asset('ui/backend/css/custom.css') }}">
</head>

<h1 style="margin-bottom: 50px; color:rgb(243, 76, 16)"><strong>Administrative Panel</strong></h1>
<body class="hold-transition login-page">
    <div class="login-box">
        @include('message')
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="#" class="h3"><strong>Mum International</strong></a>
            </div>
            <div class="card-body">
